...
public class FFMpeg {
	...
	public static final String[] defaultLIBS = new String[] { "ffmpeg", "jniaudio9",
			"jnivideo9", "ffmpeg_jni9"};

	public static final String[] EXTENSIONS = new String[] { ".mp4", ".flv",
			".avi", ".wmv", ".ts", ".ogg", ".ogv", ".rm", ".rmvb" };
	...
	String[] getLibsBySDKVesion(int sdkVersion) {
		...
		case VERSION_CODES.GINGERBREAD_MR1:
			return new String[] {
					"ffmpeg",
					"jniaudio9", // used for access to android
					"jnivideo9",
		...
		case 15:
			return new String[] {
					"ffmpeg",
					"jniaudio14", // used for access to android
					"jnivideo14",
