...
class DecoderVideo: public BuddyRunnable, public IDecoder {
public:
	DecoderVideo(AVStream* stream, PacketQueue *queue, Thread *loopThread);
...
private:
	...
	int synchronize(AVFrame *src_frame, double pts, double clock);
	// buddy interface
