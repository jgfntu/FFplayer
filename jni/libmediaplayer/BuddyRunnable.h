...
namespace ffplayer
{
    class BuddyRunnable
    {
        public:
             ...
             */
            enum { GC_BY_EXTERNAL, GC_BY_SELF };

            typedef enum BuddyType { INITIATOR, NEUTRAL, FOLLOWER } BuddyType;
            typedef enum EventType { AV_SYNC, } EventType;
            ...
            virtual int onBuddyEvent(BuddyRunnable * buddy,
                                     BuddyEvent      evt) = 0;
