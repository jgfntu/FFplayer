...
{
    __android_log_print(ANDROID_LOG_INFO, TAG, "JNIFFmpegMediaPlayerListener::notify() in msg:%d", msg);
    JNIEnv *env = getJNIEnv();
...
static void
com_media_ffmpeg_FFMpeg_native_init(JNIEnv *env)
{
	__android_log_print(ANDROID_LOG_INFO, TAG, "native_init for class FFmpeg");
...
static JNINativeMethod gMethods4FFPlayer[] = {
...
int register_android_media_FFMpegPlayerAndroid(JNIEnv *env) {
	return jniRegisterNativeMethods(env, kClassPathName, gMethods4FFPlayer, sizeof(gMethods4FFPlayer) / sizeof(gMethods4FFPlayer[0]));
}

static JNINativeMethod gMethods4FFMpeg[] = {
    {"native_init",         "()V",                              (void *)com_media_ffmpeg_FFMpeg_native_init},
};

int register_android_media_FFMpeg(JNIEnv *env) {
	return jniRegisterNativeMethods(env, "com/media/ffmpeg/FFMpeg", gMethods4FFMpeg, sizeof(gMethods4FFMpeg) / sizeof(gMethods4FFMpeg[0]));
}
