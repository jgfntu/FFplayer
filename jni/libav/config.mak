...
LIBAV_CONFIGURATION=--target-os=linux --enable-cross-compile --sysroot=/home/faywong/libav_prebuilt/ndk_standalone/sysroot --cross-prefix=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi- --arch=armv6t2 --enable-pic --extra-cflags='-fPIC -DANDROID' --enable-shared --disable-static --disable-avdevice --disable-asm --disable-yasm --disable-programs
prefix=/usr/local
...
ARCH=c
CC=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-gcc
AS=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-gcc
LD=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-gcc
DEPCC=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/home/faywong/libav_prebuilt/ndk_standalone/bin/arm-linux-androideabi-ranlib
LN_S=ln -sf
CPPFLAGS= --sysroot=/home/faywong/libav_prebuilt/ndk_standalone/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -fPIC -DANDROID  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=declaration-after-statement -Werror=vla
ASFLAGS=  -fPIC -DANDROID  -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_O=-o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=  --sysroot=/home/faywong/libav_prebuilt/ndk_standalone/sysroot -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
